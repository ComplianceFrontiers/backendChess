...
from app.database import form_Bear_Middletown_Chess_Coaching
...
form_Bear_Middletown_Chess_Coaching_bp = Blueprint('form_Bear_Middletown_Chess_Coaching', __name__)
...
def generate_unique_profile_id():
    while True:
        ...
        if form_Bear_Middletown_Chess_Coaching.count_documents({"profile_id": profile_id}) == 0:
            return profile_id

@form_Bear_Middletown_Chess_Coaching_bp.route('/form_Bear_Middletown_Chess_Coaching_bp_submit', methods=['POST'])
def form_Bear_Middletown_Chess_Coaching_bp_submit():
    try:
...
@form_Bear_Middletown_Chess_Coaching_bp.route('/form_Bear_Middletown_Chess_Coaching_bp_delete_records_by_profile_ids', methods=['DELETE'])
def form_Bear_Middletown_Chess_Coaching_bp_delete_records_by_profile_ids():
    try:
        ...
        for profile_id in profile_ids:
            ...
            result = form_Bear_Middletown_Chess_Coaching.delete_one({"profile_id": str(profile_id)})
...
@form_Bear_Middletown_Chess_Coaching_bp.route('/get_forms_form_Bear_Middletown_Chess_Coaching', methods=['GET'])
def get_forms_form_Bear_Middletown_Chess_Coaching():
    try:
        # Fetch all documents from the collection in descending order
        records = list(form_Bear_Middletown_Chess_Coaching.find({}, {'_id': 0}).sort([('_id', -1)]))  # Sort by '_id' in descending order
...
@form_Bear_Middletown_Chess_Coaching_bp.route('/form_Bear_Middletown_Chess_Coaching_by_profile_id', methods=['GET'])
def get_form_Bear_Middletown_Chess_Coaching_by_profile_id():
    try:
        ...
        record = form_Bear_Middletown_Chess_Coaching.find_one({"profile_id": str(profile_id)}, {'_id': 0})  # Exclude MongoDB's default '_id' field
